...
export const AP_SUBJECTS: APSubject[] = [
  // Sciences
  { id: 'ap-physics-1', name: 'AP Physics 1: Algebra-Based', shortName: 'Physics 1', icon: '⚛️', category: 'sciences', scoreRange: { min: 1, max: 5 }, description: 'Algebra-based physics: mechanics, waves, circuits' },
  ...
  { id: 'ap-us-gov', name: 'AP United States Government and Politics', shortName: 'US Gov', icon: '🏛️', category: 'history', scoreRange: { min: 1, max: 5 }, description: 'Constitutional foundations, institutions, policy' },
  ...
  { id: 'ap-micro', name: 'AP Microeconomics', shortName: 'Micro', icon: '📦', category: 'history', scoreRange: { min: 1, max: 5 }, description: 'Supply & demand, market structures, factor markets' },
  ...
  // Languages
  { id: 'ap-french', name: 'AP French Language and Culture', shortName: 'French', icon: '🇫🇷', category: 'languages', scoreRange: { min: 1, max: 5 }, description: 'French language proficiency and cultural understanding' },
  { id: 'ap-spanish-lit', name: 'AP Spanish Literature and Culture', shortName: 'Spanish Lit', icon: '🇪🇸', category: 'languages', scoreRange: { min: 1, max: 5 }, description: 'Spanish literary analysis and cultural exploration' },
  { id: 'ap-german', name: 'AP German Language and Culture', shortName: 'German', icon: '🇩🇪', category: 'languages', scoreRange: { min: 1, max: 5 }, description: 'German language proficiency and cultural understanding' },
  { id: 'ap-italian', name: 'AP Italian Language and Culture', shortName: 'Italian', icon: '🇮🇹', category: 'languages', scoreRange: { min: 1, max: 5 }, description: 'Italian language proficiency and cultural understanding' },
];
