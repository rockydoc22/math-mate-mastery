    ...
    competitions: [
      ...
      },
      {
        ...
        sampleQuestions: [
          ...
          { id: 'ybc-2', difficulty: 'Easy', question: 'Which of these is a physical change, not a chemical change?', options: ['Burning wood', 'Melting ice', 'Rusting iron', 'Baking a cake'], answer: 'Melting ice', explanation: 'Melting only changes state (solid → liquid); no new substance forms. The others create new substances.', topic: 'Physical vs Chemical Change' },
          { id: 'ybc-3', difficulty: 'Easy', question: 'What is the smallest particle of an element that still has the properties of that element?', options: ['Molecule', 'Atom', 'Cell', 'Compound'], answer: 'Atom', explanation: 'An atom is the smallest unit of an element that keeps that element\'s properties.', topic: 'Atomic Structure' },
          { id: 'ybc-4', difficulty: 'Easy', question: 'What is the chemical symbol for gold?', options: ['Go', 'Gd', 'Au', 'Ag'], answer: 'Au', explanation: 'Au comes from the Latin word "aurum" meaning gold. Ag is silver.', topic: 'Periodic Table' },
          { id: 'ybc-5', difficulty: 'Medium', question: 'Which lab safety item should you ALWAYS wear when handling chemicals?', options: ['Sandals', 'Safety goggles', 'A hat', 'Headphones'], answer: 'Safety goggles', explanation: 'Eye protection is the #1 rule in a chemistry lab — splashes can cause permanent damage.', topic: 'Lab Safety' },
          { id: 'ybc-6', difficulty: 'Easy', question: 'What is the pH of pure water at room temperature?', options: ['0', '7', '10', '14'], answer: '7', explanation: 'Pure water is neutral, with a pH of 7. Below 7 is acidic; above 7 is basic.', topic: 'Acids & Bases' },
          { id: 'ybc-7', difficulty: 'Medium', question: 'Which state of matter has a definite volume but no definite shape?', options: ['Solid', 'Liquid', 'Gas', 'Plasma'], answer: 'Liquid', explanation: 'Liquids keep their volume but take the shape of their container. Solids keep both; gases keep neither.', topic: 'States of Matter' },
          { id: 'ybc-8', difficulty: 'Medium', question: 'What gas do plants take in from the air during photosynthesis?', options: ['Oxygen', 'Nitrogen', 'Carbon dioxide', 'Hydrogen'], answer: 'Carbon dioxide', explanation: 'Plants absorb CO₂ and release O₂ during photosynthesis. This is everyday chemistry in action.', topic: 'Everyday Chemistry' },
          { id: 'ybc-9', difficulty: 'Medium', question: 'On the periodic table, elements in the same column (group) share what?', options: ['The same mass', 'The same number of protons', 'Similar chemical properties', 'The same color'], answer: 'Similar chemical properties', explanation: 'Group members have the same number of valence (outer) electrons, giving them similar reactivity.', topic: 'Periodic Table' },
          { id: 'ybc-10', difficulty: 'Medium', question: 'What do you call a substance that speeds up a chemical reaction without being used up?', options: ['Reactant', 'Product', 'Catalyst', 'Solvent'], answer: 'Catalyst', explanation: 'A catalyst lowers the activation energy of a reaction and is regenerated at the end. Enzymes are biological catalysts.', topic: 'Reaction Rates' },
        ]
      },
    ]
  },
