...
import satEnglish9B4Raw from './sat_english_level9_100_b4.json';
import satEnglish10B4Raw from './sat_english_level10_100_b4.json';
import satMath9B4Raw from './sat_math_level9_100_b4.json';
import satMath10B4Raw from './sat_math_level10_100_b4.json';
...
export const satMathLevel9Questions: Question[] = [
  ...
  ...convertToMath(satMath9B4Raw as RawJsonQuestion[], 'b4_'),
];
export const satMathLevel10Questions: Question[] = [
  ...
  ...convertToMath(satMath10B4Raw as RawJsonQuestion[], 'b4_'),
];
export const satEnglishLevel9Questions: EnglishQuestion[] = [
  ...
  ...convertToEnglish(satEnglish9B4Raw as RawJsonQuestion[], 'b4_'),
];
export const satEnglishLevel10Questions: EnglishQuestion[] = [
  ...
  ...convertToEnglish(satEnglish10B4Raw as RawJsonQuestion[], 'b4_'),
];
