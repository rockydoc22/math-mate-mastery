...
const generateLevel7Questions = (): VisualQuestion[] => {
  ...
  // Each entry: { ineq, answer, wrongs } where wrongs are 3 plausible-but-wrong alternatives
  const quadIneqQuestions: { ineq: string; answer: string; wrongs: [string, string, string] }[] = [
    { ineq: "(x-1)(x-4) < 0", answer: "1 < x < 4", wrongs: ["x < 1 or x > 4", "-4 < x < -1", "x ≤ 1 or x ≥ 4"] },
    { ineq: "(x-2)(x-5) < 0", answer: "2 < x < 5", wrongs: ["x < 2 or x > 5", "-5 < x < -2", "x ≤ 2 or x ≥ 5"] },
    { ineq: "(x-3)(x-6) < 0", answer: "3 < x < 6", wrongs: ["x < 3 or x > 6", "0 < x < 3", "x ≤ 3 or x ≥ 6"] },
    { ineq: "(x+1)(x-3) < 0", answer: "-1 < x < 3", wrongs: ["x < -1 or x > 3", "-3 < x < 1", "x ≤ -1 or x ≥ 3"] },
    { ineq: "(x+2)(x-4) < 0", answer: "-2 < x < 4", wrongs: ["x < -2 or x > 4", "-4 < x < 2", "x ≤ -2 or x ≥ 4"] },
    { ineq: "(x-1)(x-5) > 0", answer: "x < 1 or x > 5", wrongs: ["1 < x < 5", "x < -5 or x > -1", "x ≤ 1 or x ≥ 5"] },
    { ineq: "(x-2)(x-6) > 0", answer: "x < 2 or x > 6", wrongs: ["2 < x < 6", "x ≤ 2 or x ≥ 6", "x < -6 or x > -2"] },
    { ineq: "(x+1)(x-4) > 0", answer: "x < -1 or x > 4", wrongs: ["-1 < x < 4", "x ≤ -1 or x ≥ 4", "x < -4 or x > 1"] },
    { ineq: "(x-0)(x-5) < 0", answer: "0 < x < 5", wrongs: ["x < 0 or x > 5", "-5 < x < 0", "x ≤ 0 or x ≥ 5"] },
    { ineq: "(x-2)(x-7) < 0", answer: "2 < x < 7", wrongs: ["x < 2 or x > 7", "-7 < x < -2", "x ≤ 2 or x ≥ 7"] },
    { ineq: "(x+3)(x-2) < 0", answer: "-3 < x < 2", wrongs: ["x < -3 or x > 2", "-2 < x < 3", "x ≤ -3 or x ≥ 2"] },
    { ineq: "(x-4)(x-8) < 0", answer: "4 < x < 8", wrongs: ["x < 4 or x > 8", "-8 < x < -4", "x ≤ 4 or x ≥ 8"] },
    { ineq: "(x+2)(x-6) > 0", answer: "x < -2 or x > 6", wrongs: ["-2 < x < 6", "x ≤ -2 or x ≥ 6", "x < -6 or x > 2"] },
    { ineq: "(x-1)(x-6) < 0", answer: "1 < x < 6", wrongs: ["x < 1 or x > 6", "-6 < x < -1", "x ≤ 1 or x ≥ 6"] },
    { ineq: "(x-3)(x-7) > 0", answer: "x < 3 or x > 7", wrongs: ["3 < x < 7", "x ≤ 3 or x ≥ 7", "x < -7 or x > -3"] },
    { ineq: "(x+4)(x-1) < 0", answer: "-4 < x < 1", wrongs: ["x < -4 or x > 1", "-1 < x < 4", "x ≤ -4 or x ≥ 1"] },
    { ineq: "(x-2)(x-8) < 0", answer: "2 < x < 8", wrongs: ["x < 2 or x > 8", "-8 < x < -2", "x ≤ 2 or x ≥ 8"] },
    { ineq: "(x+1)(x-5) > 0", answer: "x < -1 or x > 5", wrongs: ["-1 < x < 5", "x ≤ -1 or x ≥ 5", "x < -5 or x > 1"] },
    { ineq: "(x-3)(x-8) < 0", answer: "3 < x < 8", wrongs: ["x < 3 or x > 8", "-8 < x < -3", "x ≤ 3 or x ≥ 8"] },
    { ineq: "(x+2)(x-7) > 0", answer: "x < -2 or x > 7", wrongs: ["-2 < x < 7", "x ≤ -2 or x ≥ 7", "x < -7 or x > 2"] },
    { ineq: "(x-4)(x-9) < 0", answer: "4 < x < 9", wrongs: ["x < 4 or x > 9", "-9 < x < -4", "x ≤ 4 or x ≥ 9"] },
    { ineq: "(x+3)(x-4) < 0", answer: "-3 < x < 4", wrongs: ["x < -3 or x > 4", "-4 < x < 3", "x ≤ -3 or x ≥ 4"] },
    { ineq: "(x-1)(x-7) > 0", answer: "x < 1 or x > 7", wrongs: ["1 < x < 7", "x ≤ 1 or x ≥ 7", "x < -7 or x > -1"] },
    { ineq: "(x-5)(x-9) < 0", answer: "5 < x < 9", wrongs: ["x < 5 or x > 9", "-9 < x < -5", "x ≤ 5 or x ≥ 9"] },
    { ineq: "(x+1)(x-6) < 0", answer: "-1 < x < 6", wrongs: ["x < -1 or x > 6", "-6 < x < 1", "x ≤ -1 or x ≥ 6"] },
    { ineq: "(x-2)(x-9) > 0", answer: "x < 2 or x > 9", wrongs: ["2 < x < 9", "x ≤ 2 or x ≥ 9", "x < -9 or x > -2"] },
    { ineq: "(x+4)(x-3) < 0", answer: "-4 < x < 3", wrongs: ["x < -4 or x > 3", "-3 < x < 4", "x ≤ -4 or x ≥ 3"] },
    { ineq: "(x-3)(x-9) < 0", answer: "3 < x < 9", wrongs: ["x < 3 or x > 9", "-9 < x < -3", "x ≤ 3 or x ≥ 9"] },
    { ineq: "(x+2)(x-8) > 0", answer: "x < -2 or x > 8", wrongs: ["-2 < x < 8", "x ≤ -2 or x ≥ 8", "x < -8 or x > 2"] },
    { ineq: "(x-1)(x-8) < 0", answer: "1 < x < 8", wrongs: ["x < 1 or x > 8", "-8 < x < -1", "x ≤ 1 or x ≥ 8"] },
    { ineq: "(x+5)(x-2) < 0", answer: "-5 < x < 2", wrongs: ["x < -5 or x > 2", "-2 < x < 5", "x ≤ -5 or x ≥ 2"] },
  ...
  quadIneqQuestions.forEach((qq, i) => {
    const [w1, w2, w3] = qq.wrongs;
    questions.push({
      id: `filler-7-quadineq-${i + 1}`,
      question: `Solve the quadratic inequality: ${qq.ineq}`,
      visual: {
        type: "table",
        data: {
          headers: ["Inequality"],
      ...
      correctAnswer: "A",
      explanation: `Find the roots of the corresponding equation, then test intervals. The solution is ${qq.answer}.`,
      difficulty: "Hard",
      domain: "Algebra",
